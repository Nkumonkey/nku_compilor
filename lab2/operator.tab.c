...
#ifndef YY_YY_OPERATOR_TAB_H_INCLUDED
# define YY_YY_OPERATOR_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_OPERATOR_TAB_H_INCLUDED  */
...
static const char *const yytname[] =
{
  ...
  "DIV", "LEFT_PAR", "RIGHT_PAR", "UMINUS", "';'", "$accept", "lines",
  "expr", YY_NULLPTR
};
#endif
...
#line 37 "operator.y"
                          { printf("%s\n", yyvsp[-1]); }
#line 1327 "operator.tab.c"
    break;

  case 5:
#line 42 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"+"); }
#line 1333 "operator.tab.c"
    break;

  case 6:
#line 43 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"- "); }
#line 1339 "operator.tab.c"
    break;

  case 7:
#line 44 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"* "); }
#line 1345 "operator.tab.c"
    break;

  case 8:
#line 45 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"/ "); }
#line 1351 "operator.tab.c"
    break;

  case 9:
#line 46 "operator.y"
                                     { yyval = yyvsp[-1]; }
#line 1357 "operator.tab.c"
    break;

  case 10:
#line 47 "operator.y"
                                   { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,"- "); strcat(yyval,yyvsp[0]); }
#line 1363 "operator.tab.c"
    break;

  case 11:
#line 48 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[0]); strcat(yyval," "); }
#line 1369 "operator.tab.c"
    break;

  case 12:
#line 49 "operator.y"
                          { yyval = (char*)malloc(50*sizeof(char)); strcpy(yyval,yyvsp[0]); strcat(yyval," "); }
#line 1375 "operator.tab.c"
    break;


#line 1379 "operator.tab.c"
